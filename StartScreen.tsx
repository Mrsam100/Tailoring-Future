  ...
  const handleFileSelect = useCallback(async (file: File) => {
    ...
    reader.onload = async (e) => {
        ...
        try {
            ...
            // "creating your studio model" fits into "The studio encountered an issue while..."
      ...
      {!userImageUrl ? (
        ...
        >
          <div className="lg:w-1/2 flex flex-col items-center lg:items-start text-center lg:text-left">
            <div className="max-w-xl">
              <span className="inline-block px-3 py-1 mb-6 text-[10px] font-bold tracking-[0.3em] uppercase bg-black text-white rounded-full">Pro Studio v1.0</span>
              ...
              <p className="mt-6 text-lg text-gray-500 leading-relaxed max-w-md">
                Experience high-fidelity virtual try-on. Our AI-driven studio transforms your portraits into digital twins for effortless wardrobe exploration.
              </p>
              <div className="mt-10 flex flex-col items-center lg:items-start w-full gap-4">
                ...
                {error && (
                  <div className="mt-4 p-4 bg-red-50 border border-red-100 rounded-xl text-red-600 text-xs font-bold uppercase tracking-wider animate-shake">
                    {error}
                  </div>
                )}
              </div>
        ...
        >
          <div className="md:w-1/2 flex-shrink-0 flex flex-col items-center md:items-start text-center md:text-left">
            ...
            <p className="text-xs uppercase tracking-[0.3em] text-gray-400 font-bold">Processing Digital Assets...</p>
            ...
            {isGenerating && (
              <div className="flex items-center gap-4 text-lg text-gray-900 font-serif mt-10 p-6 bg-white rounded-2xl shadow-sm border border-gray-100">
                <Spinner />
                <span className="italic">Synchronizing your silhouette...</span>
              </div>
            )}
